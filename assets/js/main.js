const translations = {
    en: {
        ...
        projects: {
            ...
            fleetTag: 'Fleet management',
            civicTag: 'Civic platform',
            registryTag: 'Beneficiary registry',
            institutionalTag: 'Institutional site',
            fleet: 'Fleet management system for DIF Municipal de La Paz.',
            citizenReports: 'A platform for residents to submit reports and follow their progress.',
            beneficiaries: 'A system for managing SMDIF La Paz’s beneficiary registry.',
            difWebsite: 'Official website of DIF La Paz.',
    ...
    es: {
        ...
        projects: {
            ...
            fleetTag: 'Gestión vehicular',
            civicTag: 'Plataforma ciudadana',
            registryTag: 'Padrón de beneficiarios',
            institutionalTag: 'Sitio institucional',
            fleet: 'Sistema para la gestión del parque vehicular del DIF Municipal de La Paz.',
            citizenReports: 'Plataforma para que la ciudadanía envíe reportes y dé seguimiento a su atención.',
            beneficiaries: 'Sistema para administrar el padrón de beneficiarios del SMDIF La Paz.',
            difWebsite: 'Sitio institucional del DIF La Paz.',
